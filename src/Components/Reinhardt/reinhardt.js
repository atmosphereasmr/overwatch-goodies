...
export default class Reinhardt extends Component {
  constructor(props) {
    super(props);
    this.state = {
    }
  ...
  componentDidMount() {
    ...
    const reinhardt = document.getElementById('reinhardt-tab')

    if (window.innerWidth >= 430) {
    header.style = `background-image: url("${require('../../Assets/reinhardt-header.jpg')}")`
  } else {
    header.style = "background-image: url('http://image.ibb.co/fasNz5/reinhardt_gifts_goodies_t_shirts_shirt_tee_t_tshirts_tshirt_teeshirt_tshirts_overwatch_blizzard_entertainment_clothing_clothes_merchandise.png');"
  }
    reinhardt.className = "reinhardt-tab-on"
  }

  componentWillUnmount() {
        const reinhardt = document.getElementById('reinhardt-tab')
        reinhardt.className = "reinhardt-tab-off"
  }
        ...
        <div className="main-product">
          ...
          >
              <img
                ...
                id="pic-1"
                src="https://images-na.ssl-images-amazon.com/images/I/81wMMdlzsAL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-1">
              <div className="genji-title-text-off" id="title-1">Reinhardt Vigilant Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-2">
              <div className="genji-title-text-off" id="title-2">$19.00</div>
          <a href="http://amzn.to/2yZ4kFr">
          ...
          >
              <img
                className="genji-item"
                id="pic-2"
                src="https://images-na.ssl-images-amazon.com/images/I/81F93Aa8JAL._SL1500_.jpg"
              />
              <div className="genji-title-container-begin" id="item-3">
              <div className="genji-title-text-off" id="title-3">Reinhardt Funko POP</div>
              </div>
              <div className="genji-price-container-begin" id="item-4">
              <div className="genji-title-text-off" id="title-4">$13.63</div>
                <a href="http://amzn.to/2BAPBTS">
          ...
          >
              <img
                className="genji-item"
                id="pic-3"
                src="https://images-na.ssl-images-amazon.com/images/I/81gFnaDYcCL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-5">
              <div className="genji-title-text-off" id="title-5">Reinhardt Hammer Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-6">
              <div className="genji-title-text-off" id="title-6">$19.00</div>
            <a href="http://amzn.to/2D6Dj63">
          ...
          >
              <img
                className="genji-item"
                id="pic-4"
                src="https://images-na.ssl-images-amazon.com/images/I/71kw7WxkiGL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-7">
              <div className="genji-title-text-off" id="title-7">Reinhardt Lion Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-8">
              <div className="genji-title-text-off" id="title-8">$19.00</div>
            <a href="http://amzn.to/2B28Btx">
          ...
          >
              <img
                className="genji-item"
                id="pic-5"
                src="https://images-na.ssl-images-amazon.com/images/I/51OfPB01U9L.jpg"
              />
              <div className="genji-title-container-begin" id="item-9">
              <div className="genji-title-text-off" id="title-9">Reinhardt Hammer Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-10">
              <div className="genji-title-text-off" id="title-10">$12.99</div>
                <a href="http://amzn.to/2yZKvOb">
          ...
          >
              <img
                className="genji-item"
                id="pic-6"
                src="https://images-na.ssl-images-amazon.com/images/I/91VmwAX9TwL._SL1500_.jpg"
              />
              <div className="genji-title-container-begin" id="item-11">
              <div className="genji-title-text-off" id="title-11">Reinhardt Mug</div>
              </div>
              <div className="genji-price-container-begin" id="item-12">
              <div className="genji-title-text-off" id="title-12">$17.99</div>
            <a href="http://amzn.to/2CFEYhV">
          ...
          >
              <img
                className="genji-item"
                id="pic-7"
                src="https://images-na.ssl-images-amazon.com/images/I/41-tJN9NpzL.jpg"
              />
              <div className="genji-title-container-begin" id="item-13">
              <div className="genji-title-text-off" id="title-13">Reinhardt Axe Keychain</div>
              </div>
              <div className="genji-price-container-begin" id="item-14">
              <div className="genji-title-text-off" id="title-14">$14.98</div>
              <a href="http://amzn.to/2CHYg6u">
          ...
          >
              <img
                className="genji-item"
                id="pic-8"
                src="https://images-na.ssl-images-amazon.com/images/I/813kJarSnrL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-15">
              <div className="genji-title-text-off" id="title-15">Reinhardt Justice Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-16">
              <div className="genji-title-text-off" id="title-16">$21.99</div>
              <a href="http://amzn.to/2BCLV3Z">
          ...
          >
              <img
                className="genji-item"
                id="pic-9"
                src="https://images-na.ssl-images-amazon.com/images/I/31fIeBmYKvL.jpg"
              />
              <div className="genji-title-container-begin" id="item-17">
              <div className="genji-title-text-off" id="title-17">Reinhardt Inflatable Hammer</div>
              </div>
              <div className="genji-price-container-begin" id="item-18">
              <div className="genji-title-text-off" id="title-18">$29.99</div>
              <a href="http://amzn.to/2CGD54G">
