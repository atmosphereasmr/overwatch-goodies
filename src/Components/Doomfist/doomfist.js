...
export default class Doomfist extends Component {
  constructor(props) {
    super(props);
    this.state = {
    }
  ...
  componentDidMount() {
    ...
    const doomfist = document.getElementById('doomfist-tab')

    if (window.innerWidth >= 430) {
    header.style = `background-image: url("${require('../../Assets/doomfist-header.jpg')}")`
  } else {
    header.style = "background-image: url('http://image.ibb.co/mndUE5/doomfist_overwatch_goodies_gifts_shirts_tee_shirt_clothing_merchandise_shop_presents_gifts.png')"
  }
    doomfist.className = "doomfist-tab-on"
  }

  componentWillUnmount() {
        const doomfist = document.getElementById('doomfist-tab')
        doomfist.className = "doomfist-tab-off"
  }
        ...
        <div className="main-product">
          ...
          >
              <img
                ...
                id="pic-1"
                src="https://images-na.ssl-images-amazon.com/images/I/81d4M3JB5ML._SL1328_.jpg"
              />
              <div className="genji-title-container-begin" id="item-1">
              <div className="genji-title-text-off" id="title-1">Doomfist Print</div>
              </div>
              <div className="genji-price-container-begin" id="item-2">
              <div className="genji-title-text-off" id="title-2">$16.00</div>
          <a href="http://amzn.to/2CCjbrn">
          ...
          >
              <img
                className="genji-item"
                id="pic-2"
                src="https://images-na.ssl-images-amazon.com/images/I/61BBs0wJ1hL._SX466_.jpg"
              />
              <div className="genji-title-container-begin" id="item-3">
              <div className="genji-title-text-off" id="title-3">Doomfist Poster</div>
              </div>
              <div className="genji-price-container-begin" id="item-4">
              <div className="genji-title-text-off" id="title-4">$38.45</div>
                <a href="http://amzn.to/2Bakd1y">
          ...
          >
              <img
                className="genji-item"
                id="pic-3"
                src="https://images-na.ssl-images-amazon.com/images/I/71%2B3OUFcU-L._SL1000_.jpg"
              />
              <div className="genji-title-container-begin" id="item-5">
              <div className="genji-title-text-off" id="title-5">Doomfist Wall Decal</div>
              </div>
              <div className="genji-price-container-begin" id="item-6">
              <div className="genji-title-text-off" id="title-6">$28.99</div>
            <a href="http://amzn.to/2yUgxLn">
          ...
          >
              <img
                className="genji-item"
                id="pic-4"
                src="https://images-na.ssl-images-amazon.com/images/I/71NpLhDFHZL._SL1000_.jpg"
              />
              <div className="genji-title-container-begin" id="item-7">
              <div className="genji-title-text-off" id="title-7">Doomfist Wall Decal</div>
              </div>
              <div className="genji-price-container-begin" id="item-8">
              <div className="genji-title-text-off" id="title-8">$28.99</div>
            <a href="http://amzn.to/2BupLAY">
          ...
          >
              <img
                className="genji-item"
                id="pic-5"
                src="https://images-na.ssl-images-amazon.com/images/I/61Hqc5KGvjL._SL1000_.jpg"
              />
              <div className="genji-title-container-begin" id="item-9">
              <div className="genji-title-text-off" id="title-9">Doomfist Wall Decal</div>
              </div>
              <div className="genji-price-container-begin" id="item-10">
              <div className="genji-title-text-off" id="title-10">$28.99</div>
                <a href="http://amzn.to/2kI8j3O">
