...
export default class Junkrat extends Component {
  constructor(props) {
    super(props);
    this.state = {
    }
  ...
  componentDidMount() {
    ...
    const junkrat = document.getElementById('junkrat-tab')

    if (window.innerWidth >= 430) {
    header.style = `background-image: url("${require('../../Assets/junkrat-header.jpg')}")`
  } else {
    header.style = "background-image: url('http://image.ibb.co/dDasz5/junkrat_shirt_shirts_t_shirt_tshirts_tee_teeshirt_overwatch_blizzard_clothing_clothes_merchandise.png')"
  }
    junkrat.className = "junkrat-tab-on"
  }

  componentWillUnmount() {
        const junkrat = document.getElementById('junkrat-tab')
        junkrat.className = "junkrat-tab-off"
  }
        ...
        <div className="main-product">
          ...
          >
              <img
                ...
                id="pic-1"
                src="https://images-na.ssl-images-amazon.com/images/I/71m0edbC1UL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-1">
              <div className="genji-title-text-off" id="title-1">Junkrat Logo Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-2">
              <div className="genji-title-text-off" id="title-2">$19.00</div>
          <a href="http://amzn.to/2AZcdfL">
          ...
          >
              <img
                className="genji-item"
                id="pic-2"
                src="https://images-na.ssl-images-amazon.com/images/I/61Tv0t9RCkL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-3">
              <div className="genji-title-text-off" id="title-3">Junkrat Gun Replica</div>
              </div>
              <div className="genji-price-container-begin" id="item-4">
              <div className="genji-title-text-off" id="title-4">$170.00</div>
                <a href="http://amzn.to/2CXcIs2">
          ...
          >
              <img
                className="genji-item"
                id="pic-3"
                src="https://images-na.ssl-images-amazon.com/images/I/71NvKjA0boL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-5">
              <div className="genji-title-text-off" id="title-5">Junkrat Firework Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-6">
              <div className="genji-title-text-off" id="title-6">$19.00</div>
            <a href="http://amzn.to/2Bx5ZVg">
          ...
          >
              <img
                className="genji-item"
                id="pic-4"
                src="https://images-na.ssl-images-amazon.com/images/I/81FUivbTOfL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-7">
              <div className="genji-title-text-off" id="title-7">Junkrat RIP-Tire Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-8">
              <div className="genji-title-text-off" id="title-8">$19.00</div>
            <a href="http://amzn.to/2AV8XSD">
          ...
          >
              <img
                className="genji-item"
                id="pic-5"
                src="https://images-na.ssl-images-amazon.com/images/I/81dtg7SSIHL._SY500_.jpg"
              />
              <div className="genji-title-container-begin" id="item-9">
              <div className="genji-title-text-off" id="title-9">Junkrat Painting</div>
              </div>
              <div className="genji-price-container-begin" id="item-10">
              <div className="genji-title-text-off" id="title-10">$14.95</div>
                <a href="http://amzn.to/2Bw3QJO">
          ...
          >
              <img
                className="genji-item"
                id="pic-6"
                src="https://images-na.ssl-images-amazon.com/images/I/61NCitU9IjL._SL1000_.jpg"
              />
              <div className="genji-title-container-begin" id="item-11">
              <div className="genji-title-text-off" id="title-11">Junkrat Hoodie</div>
              </div>
              <div className="genji-price-container-begin" id="item-12">
              <div className="genji-title-text-off" id="title-12">$24.50</div>
            <a href="http://amzn.to/2BvQcpT">
          ...
          >
              <img
                className="genji-item"
                id="pic-7"
                src="https://images-na.ssl-images-amazon.com/images/I/61V8p1QBqDL.jpg"
              />
              <div className="genji-title-container-begin" id="item-13">
              <div className="genji-title-text-off" id="title-13">Junkrat Statue</div>
              </div>
              <div className="genji-price-container-begin" id="item-14">
              <div className="genji-title-text-off" id="title-14">$85.99</div>
              <a href="http://amzn.to/2kJvdbd">
          ...
          >
              <img
                className="genji-item"
                id="pic-8"
                src="https://images-na.ssl-images-amazon.com/images/I/81osqC8CCEL._UX522_.jpg"
              />
              <div className="genji-title-container-begin" id="item-15">
              <div className="genji-title-text-off" id="title-15">Junkrat Spray Shirt</div>
              </div>
              <div className="genji-price-container-begin" id="item-16">
              <div className="genji-title-text-off" id="title-16">$21.99</div>
              <a href="http://amzn.to/2CYmUAu">
          ...
          >
              <img
                className="genji-item"
                id="pic-9"
                src="https://images-na.ssl-images-amazon.com/images/I/81XnIcqEbIL._SL1328_.jpg"
              />
              <div className="genji-title-container-begin" id="item-17">
              <div className="genji-title-text-off" id="title-17">Junkrat Print</div>
              </div>
              <div className="genji-price-container-begin" id="item-18">
              <div className="genji-title-text-off" id="title-18">$16.00</div>
              <a href="http://amzn.to/2AWL2lM">
